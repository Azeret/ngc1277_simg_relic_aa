...
\item The weak/moderate ETG control sequence preserves the mass--metallicity and mass--\mgfe\ calibration for normal massive ETGs while allowing only weak or moderate preserved Si-rich enrichment. The 20 Myr, $f=0.10$ channel is the conservative normal-ETG control, while stronger relic-strength preservation should be reserved for NGC~1277-like systems.
